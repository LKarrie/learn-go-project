...
func (distributor *RedisDistributor) DistributorTaskSendVerifyEmail(
	ctx context.Context,
...
func (processor *RedisTaskProcessor) ProcessTaskSendVerifyEmail(ctx context.Context, task *asynq.Task) error {
	...
	subject := "Welcome to Learn Golang Project"
	...
	Please <a href="%s">click here</a> to verify your email adderss.<br/>`, user.FullName, verifyUrl)
