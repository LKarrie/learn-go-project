...
// Source: github.com/LKarrie/learn-go-project/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) UpdateVerfyEmail(arg0 context.Context, arg1 db.UpdateVerfyEmailParams) (db.VerifyEmail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateVerfyEmail", arg0, arg1)
	ret0, _ := ret[0].(db.VerifyEmail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) UpdateVerfyEmail(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateVerfyEmail", reflect.TypeOf((*MockStore)(nil).UpdateVerfyEmail), arg0, arg1)
}
